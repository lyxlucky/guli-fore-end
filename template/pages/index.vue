    ...
    <div v-swiper:mySwiper="swiperOption">
      <div class="swiper-wrapper">
        <div
          ...
          :key="banner.id"
          class="swiper-slide"
          style="background: #040b1b; height: 300px"
        >
          <a target="_blank" href="/">
            <img :src="banner.imageUrl" :href="banner.linkUrl" :alt="banner.title" />
          </a>
        </div>
      </div>
  ...
  methods: {
    ...
    getIndexData() {
      index.getIndexData().then((resp) => {
        ...
        this.courseList = resp.data.data.courses;
      });
    },
    //查询轮播图
    getBannerList() {
      banner.getList().then((resp) => {
